		...
		<div class="btn-group btn-group-sm">
			...
			<ul class="dropdown-menu dropdown-custom dropdown-menu-right">
				<li>
					...
					if($status == 0){
					?>
					<a href="<?= site_url('tareas/cerrar_tarea/'.$id_tarea); ?>"><i class="gi gi-cloud pull-right"></i> Cerrar Tarea Cliente</a>
					<?php 
					}
					else
					{
					?>
					<a href="<?= site_url('tareas/abrir_tarea/'.$id_tarea); ?>"><i class="gi gi-cloud pull-right"></i> Abrir Tarea Cliente</a>
					<?php	
					}
					?>
				...
				<li class="divider"></li>
				<li>
					<a href="<?= site_url('tareas'); ?>" ><i class="gi gi-cloud pull-right"></i> Todos las Tareas Cliente</a>
				</li>
			</ul>
		</div>
	</div>
			...
			<div class="row">
				...
				<div class="col-xs-12 text-center">
					<div class="list-group-item">
						<a href="<?= site_url('tareas/editar_descripcion/'.$id_tarea) ?>" class="badge fancybox fancybox.iframe"><i class="fa fa-pencil"></i>  Editar</a>
