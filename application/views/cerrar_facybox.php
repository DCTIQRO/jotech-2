...
<!--[if gt IE 9]><!--> <html class="no-js"> <!--<![endif]-->
    <head>
		...
		<?php
			...
			$cssface=array('css/bootstrap.min.css','css/plugins.css','css/main.css','css/themes.css','fancy/source/jquery.fancybox.css','css/loader.css');
        ...
        <div id="page-wrapper">
            ...
            <!-- Used only if page preloader is enabled from inc/config (PHP version) or the class 'page-loading' is added in #page-wrapper element (HTML version) -->
                ...
                <div id="main-container">
                    ...
                    <!-- Page content -->
                    <div id="page-content" Style="background-color:#000">
						<ul class="loader">
						  <li>
						...
						<h1 class="text-center" Style="color:#FFF">Guardando...</h1>
						<a href="#" id="cerrar_ven" class="hidden" onclick="cerrar()">Cerrar</a>
                    </div>
                    <!-- END Page Content -->
